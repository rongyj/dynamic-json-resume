...
var MANDATORY_INFOS_ITEM_LANGUAGES = ["name"];
var MANDATORY_INFOS_ITEM_HOBBIES = ["hobby-items"];
...
var MANDATORY_INFOS = {
	...
	"item-languages": MANDATORY_INFOS_ITEM_LANGUAGES,
	"hobbies": MANDATORY_INFOS_ITEM_HOBBIES
}
...
function run(_jsonResume) {
	...
	if (resumeSection) {
		...
		return contactInfos && educationInfo && workInfo
			&& skillsInfo && languagesInfo && hobbiesInfo;
	} else {
